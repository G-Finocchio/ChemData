######### Function to read and load the BH amination data #########

read_load_BHA_data<-function()
{
# Read data
dx.train <- as.data.frame(read.table("../Analysis/Data/XTrainNScaled.txt",header=TRUE))
dx.test <- as.data.frame(read.table("../Analysis/Data/XTestNScaled.txt",header=TRUE))
dy.train <- as.data.frame(read.table("../Analysis/Data/YTrain.txt",header=FALSE))
dy.test <- as.data.frame(read.table("../Analysis/Data/YTest.txt",header=FALSE))
...
return(list(xxxx.all=xxxx.all, y.all=y.all, x.train=x.train, x.test=x.test, y.train=y.train, y.test=y.test))
}